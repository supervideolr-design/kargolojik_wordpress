<?php
/**
 * Single Post Template - Şube Detay Sayfası
 */
...
<div class="detail-section">
    ...
    <div class="branch-content" style="line-height: 1.8; color: var(--text-primary);">
        <?php the_content(); ?>
    </div>
</div>
...
<div class="action-buttons">
    <a href="https://www.google.com/maps/search/?api=1&query=<?php echo urlencode($title); ?>" target="_blank" class="action-btn maps">
...
<div style="padding: 16px; text-align: center;">
    <a href="<?php echo home_url(); ?>" style="display: inline-flex; align-items: center; gap: 8px; color: var(--primary-color); font-weight: 600;">
